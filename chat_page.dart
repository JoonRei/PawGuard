...
class _ChatPageState extends State<ChatPage> {
  ...
  @override
  void dispose() {
    _statusUpdateTimer.cancel(); // Cancel the timer
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          await _deleteMessage(
                              messageId); // Call the delete function
                        },
  ...
  String _getLastSeenText(Timestamp lastSeen) {
    ...
    if (difference.inMinutes < 1) {
      ...
      return 'yesterday at ${lastSeenDate.hour.toString().padLeft(2, '0')}:${lastSeenDate.minute.toString().padLeft(2, '0')}';
    } else {
      return '${lastSeenDate.day.toString().padLeft(2, '0')}/${lastSeenDate.month.toString().padLeft(2, '0')}/${lastSeenDate.year} at ${lastSeenDate.hour.toString().padLeft(2, '0')}:${lastSeenDate.minute.toString().padLeft(2, '0')}';
    }
  }
                  ...
                  StreamBuilder<DocumentSnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (isOnline) {
                        ...
                        final lastSeenText =
                            _getLastSeenText(lastSeen); // Format lastSeen
                        return Text(
              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isRead =
                        message['read'] ?? false; // Get the read status
                    final messageId =
                        messages[index].id; // Firestore document ID
                      ...
                      onLongPress: () {
                        if (isSentByCurrentUser) {
                          _showDeleteConfirmationDialog(
                              messageId); // Show delete confirmation
                        }
                      },
                      child: Column(
