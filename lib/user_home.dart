...
class Pet {
  ...
  final bool isDisabled; // Add this field for disability status
  ...
  return Pet(
    ...
    // New fields
    isDisabled: map['isDisabled'] ?? false, // Map the disability status
    disabilityDescription: map['disabilityDescription'] ?? '', // Map the disability description
  );
}
        ...
        MaterialPageRoute(
          builder: (context) => AnimalDetailsPage(
            animal: {
              ...
              'isDisabled': pet.isDisabled, // Pass disability status
              'disabilityDescription': pet.disabilityDescription, // Pass disability description
            },
          ),
        ),
      );
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Disability info is excluded here for featured display
                        ],
                      ),
                    ),
                  ),
