 ...
 Widget _buildTimeline() {
  final List<Map<String, dynamic>> timelineEvents = [
    ...
    // Disability event
    {
      ...
      'content': animal['isDisabled'] == true
          ? 'This pet is disabled.'
          : 'This pet is not disabled.',
      'date': '---',
    },
  ];
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                // Apply RichText only for the disability status event
                event['title'] == 'Disability Status'
                    ? RichText(
                        text: TextSpan(
                          children: [
                            TextSpan(
                            ...
                            // Only style the disability description if available
                            if (animal['isDisabled'] == true && animal['disabilityDescription'] != null && animal['disabilityDescription']!.isNotEmpty)
                              TextSpan(
                                text: '\nDisability: ${animal['disabilityDescription']}',
                                style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  color: Color(0xFFEF6B39), // Highlight disability in red
                                ),
                              ),
                          ],
                        ),
