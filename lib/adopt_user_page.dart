          ...
          suffixIcon: searchController.text.isNotEmpty
              ? IconButton(
                  ...
                  onPressed: () {
                    ...
                    setState(() {}); // Clear and trigger UI update
                  },
                )
              : null, // Only show X when there's input
        ...
        return Expanded(
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isSelected
                    ? Color(0xFFEF6B39).withOpacity(0.1)
                    : Colors.grey[50],
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
              ...
              child: Column(
                children: [
                  Icon(
                    Icons.pets,
                    color: isSelected ? Color(0xFFEF6B39) : Colors.grey,
                  ),
                  SizedBox(height: 4),
                  Text(
                    type,
                    style: TextStyle(
                      color: isSelected ? Color(0xFFEF6B39) : Colors.grey[600],
                      fontWeight:
