    ...
    return GestureDetector(
      onTap: () {
        ...
        showDialog(
          context: context,
          barrierDismissible:
              true, // Allow dismiss by tapping outside the dialog
          builder: (BuildContext context) {
            return CupertinoPageScaffold(
              backgroundColor:
                  Colors.black, // Dark background for image preview
              navigationBar: CupertinoNavigationBar(
                backgroundColor:
                    Colors.transparent, // Make the nav bar transparent
                leading:
                    Container(), // Remove the back arrow by setting leading to an empty container
              ),
              child: Center(
                child: Stack(
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.pop(
                            context); // Dismiss the preview when tapped
                      },
                      child: Container(
                        width: MediaQuery.of(context).size.width *
                            0.85, // Limit width for better design
                        height: MediaQuery.of(context).size.height *
                            0.7, // Limit height for better design
                        decoration: BoxDecoration(
                          color: Colors
                              .white, // Background color for the image container
                          borderRadius:
                        ...
                        child: userData != null && userData['image'] != null
                            ? ClipRRect(
                                ...
                                child: Image.memory(
                                  ...
                                  errorBuilder: (context, error, stackTrace) {
                                    return const Icon(
                                      Icons
                                          .person, // Default icon if image fails
                                      size: 100,
                                      color: Colors.grey,
                                    );
                                  },
                            ...
                            : Center(
                                child: Icon(
                                  Icons
                                      .person, // Default icon if no image is available
                                  size: 100,
                                  color: Colors.grey,
                                ),
                              ),
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.pop(
                              context); // Dismiss the preview when tapping on the close (X) button
                        },
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: Colors.white.withOpacity(
                                0.8), // Light background for close button
                          ),
                          child: Icon(
                            Icons.close,
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.black
                  .withOpacity(0.1), // Soft shadow for floating effect
